...
const HowItWorks = () => {
  return (
    <div className="bg-[#622E0E] text-white p-6 md:p-12 flex flex-col md:flex-row gap-8 items-center justify-center">
      {/* Left Section */}
      ...
      <div className="md:w-1/2 space-y-6">
        <div className="bg-[#F78A1A] p-4 rounded-lg relative">
        ...
        <div className="bg-[#A04C1E] p-4 rounded-lg relative">
